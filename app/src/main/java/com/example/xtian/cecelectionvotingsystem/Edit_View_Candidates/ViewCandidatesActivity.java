...
public class ViewCandidatesActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ViewCandidatesActivity.this, home.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_edit:
                Intent intent = new Intent(ViewCandidatesActivity.this,EditCandidatesAcitivity.class);
    ...
    class  CandidateViewAsync extends AsyncTask<Void,Integer,Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ViewCandidatesActivity.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (connectionlost) {
                ...
                //lost Connection
                AlertDialog.Builder alertConnectionLost = new AlertDialog.Builder(ViewCandidatesActivity.this);
    ...
    class deleteCandidatetAsync extends  AsyncTask<Void,Integer,Void>{
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            pDialog.dismiss();
            if (connectionlost){
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(ViewCandidatesActivity.this);
