 ...
 */
public class studentVote_auditor extends AppCompatActivity  {
...
//        super.onBackPressed();
        ...
        alertDialog2.setPositiveButton("YES",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(studentVote_auditor.this, studentVote_proFirst.class);
    ...
    public void displaydate(){
        ...
        ArrayList<item_views_candidates> candidates_list_array = db.Get_Auditor();
        ...
        studentVoteListAdapater = new StudentVoteListAdapater(studentVote_auditor.this,R.layout.vote_listcandidates,candidates_list);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                auditorID = ((TextView) view.findViewById(R.id.textcandidateID)).getText()
                        .toString();
                hover = i;
