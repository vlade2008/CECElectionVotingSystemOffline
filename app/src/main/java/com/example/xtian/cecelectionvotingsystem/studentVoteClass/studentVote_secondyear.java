 ...
 */
public class studentVote_secondyear extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView10.setText("Second Year Representative");
...
//        super.onBackPressed();
        ...
        alertDialog2.setPositiveButton("YES",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(studentVote_secondyear.this, studentVote_thirdyear.class);
    ...
    public void displaydate(){
        ...
        ArrayList<item_views_candidates> candidates_list_array = db.Get_Secondyr();
        ...
        studentVoteListAdapater = new StudentVoteListAdapater(studentVote_secondyear.this,R.layout.vote_listcandidates,candidates_list);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                secondyearID = ((TextView) view.findViewById(R.id.textcandidateID)).getText()
                        .toString();
                hover = i;
