 ...
 */
public class studentVote_proSecond extends AppCompatActivity  {
...
//        super.onBackPressed();
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_check:
                if(proSecondID==null)
                {
                    ...
                    if (proSecondID.equals(proFirstID)){
                        Toast.makeText(getApplicationContext(), "You have already chosen these candidates", Toast.LENGTH_SHORT).show();
                    }else{
                        studentVote();
                    }
                }
        ...
        alertDialog2.setPositiveButton("YES",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(studentVote_proSecond.this, studentVote_firstyear.class);
    ...
    public void displaydate(){
        ...
        ArrayList<item_views_candidates> candidates_list_array = db.Get_Profirst();
        ...
        studentVoteListAdapater = new StudentVoteListAdapater(studentVote_proSecond.this,R.layout.vote_listcandidates,candidates_list);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                proSecondID = ((TextView) view.findViewById(R.id.textcandidateID)).getText()
                        .toString();
                hover = i;
