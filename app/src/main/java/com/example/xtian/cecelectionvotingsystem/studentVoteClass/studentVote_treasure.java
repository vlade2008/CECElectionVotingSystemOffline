 ...
 */
public class studentVote_treasure extends AppCompatActivity  {
...
//        super.onBackPressed();
        ...
        alertDialog2.setPositiveButton("YES",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(studentVote_treasure.this, studentVote_auditor.class);
    ...
    public void displaydate(){
        ...
        ArrayList<item_views_candidates> candidates_list_array = db.Get_Treasurer();
        ...
        studentVoteListAdapater = new StudentVoteListAdapater(studentVote_treasure.this,R.layout.vote_listcandidates,candidates_list);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                tresureID = ((TextView) view.findViewById(R.id.textcandidateID)).getText()
                        .toString();
                hover = i;
