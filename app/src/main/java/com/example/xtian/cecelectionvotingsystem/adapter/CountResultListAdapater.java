 ...
 */
public class CountResultListAdapater extends ArrayAdapter<ResultItem> {

    Context context;
    int layoutResourceId;
    ArrayList<ResultItem> ResultArray = new ArrayList<ResultItem>();

    public CountResultListAdapater(Context context, int layoutResourceId, ArrayList<ResultItem> ResultArray) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //tie statement
        if (resultItem.getPosition_Name().equals("tied")){
...
//            some_layout_item.startAnimation(animation);
            ...
            if (ResultArray.get(0).getPosition_Name()!= resultItem.getPosition_Name()){
                position_name.setVisibility(View.INVISIBLE);
            }
        }
        //coin statement
