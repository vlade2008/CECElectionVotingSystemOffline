...
public class ResultItem {
    ...
    public ResultItem(String student_id, String student_name, String position_name, String party_name, String candidate_vote, Bitmap imageIcon,String coin,Integer voters_count) {
        super();
        this.student_ID=student_id;
        this.student_Name=student_name;
        this.position_Name=position_name;
