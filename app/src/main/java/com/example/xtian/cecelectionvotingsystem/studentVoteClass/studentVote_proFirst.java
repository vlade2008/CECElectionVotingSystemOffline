 ...
 */
public class studentVote_proFirst extends AppCompatActivity  {
...
//        super.onBackPressed();
        ...
        alertDialog2.setPositiveButton("YES",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(studentVote_proFirst.this, studentVote_proSecond.class);
    ...
    public void displaydate(){
        ...
        studentVoteListAdapater = new StudentVoteListAdapater(studentVote_proFirst.this,R.layout.vote_listcandidates,candidates_list);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                proFirstID = ((TextView) view.findViewById(R.id.textcandidateID)).getText()
                        .toString();
                hover = i;
